...
namespace webquanlykhachsan.Controllers
{
    ...
    public class RoomTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,BasePrice,Description,Capacity,ImageUrl")] RoomType roomType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,BasePrice,Description,Capacity,ImageUrl")] RoomType roomType)
        {
            if (id != roomType.Id)
            {
                return NotFound();
