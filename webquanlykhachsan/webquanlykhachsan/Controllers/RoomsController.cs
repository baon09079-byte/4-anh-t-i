...
namespace webquanlykhachsan.Controllers
{
    ...
    public class RoomsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Number,Floor,Status,RoomTypeId")] Room room)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Number,Floor,Status,RoomTypeId")] Room room)
        {
            if (id != room.Id)
            {
                return NotFound();
